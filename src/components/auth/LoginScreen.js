...
export const LoginScreen = () => {
  ...
  return (
    <>
      <h1 className="text-2xl text-center text-secondary md:text-3xl font-bold mb-8">Ingresa a tu cuenta</h1>
      <form className="flex flex-col" onSubmit={ handleLogin }>
        ...
        <button
          ...
          className="mt-1 bg-gray-300 px-4 py-2 rounded-lg text-black text-sm font-bold flex items-center justify-center focus:outline-none">
        ...
        <Link to="/auth/register" className="text-center mt-5 font-medium text-secondary hover:underline">
          ó Crear una cuenta nueva
        </Link>
      </form>
    </>
  )
